...
SELECT [Name], Price, (Price * COUNT(ProductID)) AS Total_Revenue FROM Customer.Products JOIN Customer.Orders ON
Customer.Products.ID = Customer.Orders.ProductID WHERE [Name] = 'iPhone' GROUP BY [Name], Price

UPDATE Customer.Products SET Price = 250 WHERE [Name] = 'iPhone'

SELECT * FROM Customer.Products WHERE [Name] = 'iPhone'